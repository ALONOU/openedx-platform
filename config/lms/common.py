# -*- coding: utf-8 -*-
"""
Common Django settings for Open edX LMS (Native Setup)
...
LMS_BASE = os.environ.get('LMS_HOST', 'localhost')
...
# ============================================================================
# INSTALLED APPS (MVP - Minimal Configuration)
# ============================================================================
...
FEATURES = {
    ...
    'ENABLE_GRADE_DOWNLOADS': os.environ.get('ENABLE_GRADE_DOWNLOADS', 'true').lower() == 'true',
    'ENABLE_INSTRUCTOR_EMAIL': os.environ.get('ENABLE_INSTRUCTOR_EMAIL', 'true').lower() == 'true',
    'ENABLE_CERTIFICATES': os.environ.get('ENABLE_CERTIFICATES', 'true').lower() == 'true',
    'ENABLE_COHORTS': os.environ.get('ENABLE_COHORTS', 'true').lower() == 'true',
    'ENABLE_COURSE_GROUPS': True,
    'ENABLE_BULK_EMAIL': os.environ.get('ENABLE_BULK_EMAIL', 'true').lower() == 'true',
    'ENABLE_INSTRUCTOR_ANALYTICS': True,  # Basic analytics
    'ENABLE_STUDENT_NOTES': os.environ.get('ENABLE_STUDENT_NOTES', 'true').lower() == 'true',
    'ENABLE_EDXNOTES': True,
    'ENABLE_PREREQUISITE_COURSES': os.environ.get('ENABLE_PREREQUISITE_COURSES', 'true').lower() == 'true',
    'ENABLE_ENTRANCE_EXAMS': os.environ.get('ENABLE_ENTRANCE_EXAMS', 'true').lower() == 'true',
    'ENABLE_SPECIAL_EXAMS': True,  # Timed exams
    'ENABLE_MOBILE_REST_API': True,  # Keep for mobile-first
    
    # MVP DISABLED Features (V2)
    'ENABLE_DISCUSSION_SERVICE': os.environ.get('ENABLE_DISCUSSION_SERVICE', 'false').lower() == 'true',
    ...
    'ENABLE_SCORM': os.environ.get('ENABLE_SCORM', 'false').lower() == 'true',
    'ENABLE_XAPI': os.environ.get('ENABLE_XAPI', 'false').lower() == 'true',
    'ENABLE_COURSE_DISCOVERY': os.environ.get('ENABLE_COURSE_DISCOVERY', 'false').lower() == 'true',
    'ENABLE_TEAMS': os.environ.get('ENABLE_TEAMS', 'false').lower() == 'true',
    'ENABLE_WIKI': os.environ.get('ENABLE_WIKI', 'false').lower() == 'true',
